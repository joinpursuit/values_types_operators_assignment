...
* `1 + 2 * 3 + 4`  Numbers and Operators to perform mathematical arithmetic. Evaluates to: 11 because math works normally in JS.
* `800 / 80 / 8`  Numbers and Operators performing division. Evaluates to: 1.25 because math works normally in JS.
